...
func (p *Pipeline) GameServerCreateSucceed(logger *zap.Logger, session *SessionWS, envelope *rtapi.Envelope) (bool, *rtapi.Envelope) {
	...
	if err != nil && err != ErrSessionQueueFull {
